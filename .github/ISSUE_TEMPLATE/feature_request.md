...
about: Suggest a new feature or enhancement for the FastPix PHP SDK
title: '[FEATURE] '
...
Thank you for suggesting a new feature for the FastPix PHP SDK! Please provide the following information to help us understand and evaluate your request:
...
```
<!-- How do other PHP SDKs handle this? -->
```
## Priority
