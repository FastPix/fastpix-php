...
class Playback
{
    ...
    public function createMediaPlaybackId(string $mediaId, ?Operations\CreateMediaPlaybackIdRequestBody $requestBody = null, ?Options $options = null): Operations\CreateMediaPlaybackIdResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'create-media-playback-id', [], $this->sdkConfiguration->securitySource);
    ...
    public function deleteMediaPlaybackId(string $mediaId, string $playbackId, ?Options $options = null): Operations\DeleteMediaPlaybackIdResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'delete-media-playback-id', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
    ...
    public function getPlaybackId(string $mediaId, string $playbackId, ?Options $options = null): Operations\GetPlaybackIdResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get-playback-id', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
