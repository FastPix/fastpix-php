...
class ManageVideos
{
     ...
     *
     *
     * @param  Operations\AddMediaTrackRequestBody  $requestBody
     * @param  string  $mediaId
     * @return Operations\AddMediaTrackResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function addMediaTrack(Operations\AddMediaTrackRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\AddMediaTrackResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'Add-media-track', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['201'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\AddMediaTrackResponse(
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\FastPix\Sdk\Models\Errors\TrackDuplicateRequestException', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function generateSubtitleTrack(Components\TrackSubtitlesGenerateRequest $trackSubtitlesGenerateRequest, string $mediaId, string $trackId, ?Options $options = null): Operations\GenerateSubtitleTrackResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'trackSubtitlesGenerateRequest', 'json');
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $httpOptions = array_merge_recursive($httpOptions, $body);
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('POST', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'Generate-subtitle-track', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\GenerateSubtitleTrackResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function cancelUpload(string $uploadId, ?Options $options = null): Operations\CancelUploadResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'cancel-upload', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\CancelUploadResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
    ...
    public function deleteMedia(string $mediaId, ?Options $options = null): Operations\DeleteMediaResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'delete-media', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function deleteMediaTrack(string $mediaId, string $trackId, ?Options $options = null): Operations\DeleteMediaTrackResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('DELETE', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'delete-media-track', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\DeleteMediaTrackResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
    ...
    public function getMedia(string $mediaId, ?Options $options = null): Operations\GetMediaResponse
    {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get-media', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function getMediaClips(string $sourceMediaId, ?int $offset = null, ?int $limit = null, ?Components\SortOrder $orderBy = null, ?Options $options = null): Operations\GetMediaClipsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $baseUrl = $this->sdkConfiguration->getTemplatedServerUrl();
        $url = Utils\Utils::generateUrl($baseUrl, '/on-demand/{sourceMediaId}/media-clips', Operations\GetMediaClipsRequest::class, $request);
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'get-media-clips', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\GetMediaClipsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\FastPix\Sdk\Models\Errors\MediaClipNotFoundException', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $obj->rawResponse = $httpResponse;
                throw $obj->toException();
            } else {
                throw new \FastPix\Sdk\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function listLiveClips(string $livestreamId, ?int $limit = null, ?int $offset = null, ?Components\SortOrder $orderBy = null, ?Options $options = null): Operations\ListLiveClipsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list-live-clips', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\ListLiveClipsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function listMedia(?int $limit = null, ?int $offset = null, ?Components\SortOrder $orderBy = null, ?Options $options = null): Operations\ListMediaResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list-media', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function listUploads(?int $limit = null, ?int $offset = null, ?Components\SortOrder $orderBy = null, ?Options $options = null): Operations\ListUploadsResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'list-uploads', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions['query'] = Utils\QueryParameters::standardizeQueryParams($httpRequest, $qp);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\ListUploadsResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
    ...
    public function retrieveMediaInputInfo(string $mediaId, ?Options $options = null): Operations\RetrieveMediaInputInfoResponse
    {
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('GET', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'retrieveMediaInputInfo', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaTrack(Components\UpdateTrackRequest $updateTrackRequest, string $trackId, string $mediaId, ?Options $options = null): Operations\UpdateMediaTrackResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $urlOverride = null;
        $httpOptions = ['http_errors' => false];
        $body = Utils\Utils::serializeRequestBody($request, 'updateTrackRequest', 'json');
        if ($body === null) {
            throw new \Exception('Request body is required');
        }
        $httpOptions = array_merge_recursive($httpOptions, $body);
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update-media-track', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\UpdateMediaTrackResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
     ...
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updatedMedia(Operations\UpdatedMediaRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\UpdatedMediaResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PATCH', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'updated-media', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
     ...
     *
     *
     * @param  Operations\UpdatedMp4SupportRequestBody  $requestBody
     * @param  string  $mediaId
     * @return Operations\UpdatedMp4SupportResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updatedMp4Support(Operations\UpdatedMp4SupportRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\UpdatedMp4SupportResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PATCH', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'updated-mp4Support', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\UpdatedMp4SupportResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
            ...
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\FastPix\Sdk\Models\Errors\DuplicateMp4SupportException', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $obj->rawResponse = $httpResponse;
                throw $obj->toException();
            } else {
                throw new \FastPix\Sdk\Models\Errors\APIException('Unknown content type received', $statusCode, $httpResponse->getBody()->getContents(), $httpResponse);
     ...
     *
     *
     * @param  Operations\UpdatedSourceAccessRequestBody  $requestBody
     * @param  string  $mediaId
     * @return Operations\UpdatedSourceAccessResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updatedSourceAccess(Operations\UpdatedSourceAccessRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\UpdatedSourceAccessResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PATCH', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'updated-source-access', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\UpdatedSourceAccessResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    rawResponse: $httpResponse,
                    object: $obj);
     ...
     *
     * Updates the summary information for a specific media file. This endpoint allows you to modify the summary text, description, or other summary-related metadata associated with the media.
     *
     * @param  string  $mediaId
     * @param  Components\UpdateMediaSummaryRequestBody  $requestBody
     * @param  ?Options  $options
     * @return Operations\UpdateMediaSummaryResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaSummary(string $mediaId, Components\UpdateMediaSummaryRequestBody $requestBody, ?Options $options = null): Operations\UpdateMediaSummaryResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $operationsRequestBody = new Operations\UpdateMediaSummaryRequestBody(
            generate: $requestBody->summary !== null,
            summaryLength: 100
        );
        $requestObj = new Operations\UpdateMediaSummaryRequest(
            mediaId: $mediaId,
            requestBody: $operationsRequestBody,
        );
        $requestBodyData = Utils\Utils::serializeRequestBody($requestObj, 'requestBody', 'json');
        $request = new \GuzzleHttp\Psr7\Request('PATCH', Utils\Utils::generateUrl($this->sdkConfiguration->getTemplatedServerUrl(), '/on-demand/{mediaId}/summary', Operations\UpdateMediaSummaryRequest::class, $requestObj), [
            'user-agent' => $this->sdkConfiguration->userAgent,
            'Accept' => 'application/json',
            'Content-Type' => 'application/json',
        ], $requestBodyData['body'] ?? null);

        $hookCtx = new Hooks\HookContext($this->sdkConfiguration, $this->sdkConfiguration->getTemplatedServerUrl(), 'updateMediaSummary', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\FastPix\Sdk\Models\Operations\UpdateMediaSummaryResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $obj->rawResponse = $httpResponse;
     ...
     *
     * Updates the chapter information for a specific media file. This endpoint allows you to modify chapter markers, timestamps, and chapter metadata.
     *
     * @param  string  $mediaId
     * @param  Components\UpdateMediaChaptersRequestBody  $requestBody
     * @param  ?Options  $options
     * @return Operations\UpdateMediaChaptersResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaChapters(string $mediaId, Components\UpdateMediaChaptersRequestBody $requestBody, ?Options $options = null): Operations\UpdateMediaChaptersResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $operationsRequestBody = new Operations\UpdateMediaChaptersRequestBody(
            chapters: $requestBody->chapters ?? true
        );
        $requestObj = new Operations\UpdateMediaChaptersRequest(
            mediaId: $mediaId,
            requestBody: $operationsRequestBody,
        );
        $requestBodyData = Utils\Utils::serializeRequestBody($requestObj, 'requestBody', 'json');
        $request = new \GuzzleHttp\Psr7\Request('PATCH', Utils\Utils::generateUrl($this->sdkConfiguration->getTemplatedServerUrl(), '/on-demand/{mediaId}/chapters', Operations\UpdateMediaChaptersRequest::class, $requestObj), [
            'user-agent' => $this->sdkConfiguration->userAgent,
            'Accept' => 'application/json',
            'Content-Type' => 'application/json',
        ], $requestBodyData['body'] ?? null);

        $hookCtx = new Hooks\HookContext($this->sdkConfiguration, $this->sdkConfiguration->getTemplatedServerUrl(), 'updateMediaChapters', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\FastPix\Sdk\Models\Operations\UpdateMediaChaptersResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $obj->rawResponse = $httpResponse;
     ...
     *
     * Updates the named entity information for a specific media file. This endpoint allows you to modify extracted named entities, timestamps, and entity metadata.
     *
     * @param  string  $mediaId
     * @param  Components\UpdateMediaNamedEntitiesRequestBody  $requestBody
     * @param  ?Options  $options
     * @return Operations\UpdateMediaNamedEntitiesResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaNamedEntities(string $mediaId, Components\UpdateMediaNamedEntitiesRequestBody $requestBody, ?Options $options = null): Operations\UpdateMediaNamedEntitiesResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $operationsRequestBody = new Operations\UpdateMediaNamedEntitiesRequestBody(
            namedEntities: $requestBody->namedEntities ?? true
        );
        $requestObj = new Operations\UpdateMediaNamedEntitiesRequest(
            mediaId: $mediaId,
            requestBody: $operationsRequestBody,
        );
        $requestBodyData = Utils\Utils::serializeRequestBody($requestObj, 'requestBody', 'json');
        $request = new \GuzzleHttp\Psr7\Request('PATCH', Utils\Utils::generateUrl($this->sdkConfiguration->getTemplatedServerUrl(), '/on-demand/{mediaId}/named-entities', Operations\UpdateMediaNamedEntitiesRequest::class, $requestObj), [
            'user-agent' => $this->sdkConfiguration->userAgent,
            'Accept' => 'application/json',
            'Content-Type' => 'application/json',
        ], $requestBodyData['body'] ?? null);

        $hookCtx = new Hooks\HookContext($this->sdkConfiguration, $this->sdkConfiguration->getTemplatedServerUrl(), 'updateMediaNamedEntities', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\FastPix\Sdk\Models\Operations\UpdateMediaNamedEntitiesResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $obj->rawResponse = $httpResponse;
    ...
    /**
     * Update media moderation settings
     *
     * Updates the content moderation settings for a specific media file. This endpoint allows you to modify moderation rules, content filters, and safety settings.
     *
     * @param  string  $mediaId
     * @param  Components\UpdateMediaModerationRequestBody  $requestBody
     * @param  ?Options  $options
     * @return Operations\UpdateMediaModerationResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaModeration(string $mediaId, Components\UpdateMediaModerationRequestBody $requestBody, ?Options $options = null): Operations\UpdateMediaModerationResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $moderation = null;
        if ($requestBody->moderationSettings !== null) {
            $moderation = new Operations\UpdateMediaModerationModeration(
                type: Components\MediaType::Video
            );
        }
        $operationsRequestBody = new Operations\UpdateMediaModerationRequestBody(
            moderation: $moderation
        );
        $requestObj = new Operations\UpdateMediaModerationRequest(
            mediaId: $mediaId,
            requestBody: $operationsRequestBody,
        );
        $requestBodyData = Utils\Utils::serializeRequestBody($requestObj, 'requestBody', 'json');
        $request = new \GuzzleHttp\Psr7\Request('PATCH', Utils\Utils::generateUrl($this->sdkConfiguration->getTemplatedServerUrl(), '/on-demand/{mediaId}/moderation', Operations\UpdateMediaModerationRequest::class, $requestObj), [
            'user-agent' => $this->sdkConfiguration->userAgent,
            'Accept' => 'application/json',
            'Content-Type' => 'application/json',
        ], $requestBodyData['body'] ?? null);

        $hookCtx = new Hooks\HookContext($this->sdkConfiguration, $this->sdkConfiguration->getTemplatedServerUrl(), 'updateMediaModeration', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $serializer = Utils\JSON::createSerializer();
                $responseData = (string) $httpResponse->getBody();
                $obj = $serializer->deserialize($responseData, '\FastPix\Sdk\Models\Operations\UpdateMediaModerationResponse', 'json', DeserializationContext::create()->setRequireAllRequiredProperties(true));
                $obj->rawResponse = $httpResponse;
