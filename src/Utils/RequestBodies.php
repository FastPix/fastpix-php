...
class RequestBodies
{
    ...
    {
        $attributes = $property->getAttributes(FastPixMetadata::class);
    ...
    {
        $metadataStr = FastPixMetadata::find($property->getAttributes(FastPixMetadata::class), 'multipartForm');
        if ($metadataStr === null) {
            return null;
        }
    ...
    {
        $metadataStr = FastPixMetadata::find($property->getAttributes(FastPixMetadata::class), 'form');
        if ($metadataStr === null) {
            return null;
        }
