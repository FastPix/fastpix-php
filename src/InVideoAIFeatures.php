...
class InVideoAIFeatures
{
     ...
     *
     *
     * @param  Operations\UpdateMediaChaptersRequestBody  $requestBody
     * @param  string  $mediaId
     * @return Operations\UpdateMediaChaptersResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaChapters(Operations\UpdateMediaChaptersRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\UpdateMediaChaptersResponse
    {
        $retryConfig = null;
        if ($options) {
        ...
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update-media-chapters', [], $this->sdkConfiguration->securitySource);
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\UpdateMediaChaptersResponse(
                    ...
                    updateMediaChaptersSuccessResponse: $obj,
     ...
     *
     *
     * @param  Operations\UpdateMediaModerationRequestBody  $requestBody
     * @param  string  $mediaId
     * @return Operations\UpdateMediaModerationResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaModeration(Operations\UpdateMediaModerationRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\UpdateMediaModerationResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PATCH', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update-media-moderation', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\UpdateMediaModerationResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    updateMediaModerationSuccessResponse: $obj,
                    rawResponse: $httpResponse);
     ...
     *
     *
     * @param  Operations\UpdateMediaNamedEntitiesRequestBody  $requestBody
     * @param  string  $mediaId
     * @return Operations\UpdateMediaNamedEntitiesResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaNamedEntities(Operations\UpdateMediaNamedEntitiesRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\UpdateMediaNamedEntitiesResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PATCH', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update-media-named-entities', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\UpdateMediaNamedEntitiesResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    updateMediaNamedEntitiesSuccessResponse: $obj,
                    rawResponse: $httpResponse);
     ...
     *
     *
     * @param  Operations\UpdateMediaSummaryRequestBody  $requestBody
     * @param  string  $mediaId
     * @return Operations\UpdateMediaSummaryResponse
     * @throws \FastPix\Sdk\Models\Errors\APIException
     */
    public function updateMediaSummary(Operations\UpdateMediaSummaryRequestBody $requestBody, string $mediaId, ?Options $options = null): Operations\UpdateMediaSummaryResponse
    {
        $retryConfig = null;
        if ($options) {
            $retryConfig = $options->retryConfig;
        ...
        $httpOptions['headers']['user-agent'] = $this->sdkConfiguration->userAgent;
        $httpRequest = new \GuzzleHttp\Psr7\Request('PATCH', $url);
        $hookContext = new HookContext($this->sdkConfiguration, $baseUrl, 'update-media-summary', [], $this->sdkConfiguration->securitySource);
        $httpRequest = $this->sdkConfiguration->hooks->beforeRequest(new Hooks\BeforeRequestContext($hookContext), $httpRequest);
        $httpOptions = Utils\Utils::convertHeadersToOptions($httpRequest, $httpOptions);
        $httpRequest = Utils\Utils::removeHeaders($httpRequest);
        try {
        ...
        if (Utils\Utils::matchStatusCodes($statusCode, ['200'])) {
            if (Utils\Utils::matchContentType($contentType, 'application/json')) {
                ...
                $response = new Operations\UpdateMediaSummaryResponse(
                    statusCode: $statusCode,
                    contentType: $contentType,
                    updateMediaSummarySuccessResponse: $obj,
                    rawResponse: $httpResponse);
