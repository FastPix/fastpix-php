...
use FastPix\Sdk\Serializer\Builder\DefaultDriverFactory;
use FastPix\Sdk\Serializer\Builder\DocBlockDriverFactory;
use FastPix\Sdk\Serializer\Builder\DriverFactoryInterface;
use FastPix\Sdk\Serializer\Construction\ObjectConstructorInterface;
use FastPix\Sdk\Serializer\Construction\UnserializeObjectConstructor;
use FastPix\Sdk\Serializer\ContextFactory\CallableDeserializationContextFactory;
use FastPix\Sdk\Serializer\ContextFactory\CallableSerializationContextFactory;
use FastPix\Sdk\Serializer\ContextFactory\DeserializationContextFactoryInterface;
use FastPix\Sdk\Serializer\ContextFactory\SerializationContextFactoryInterface;
...
use FastPix\Sdk\Serializer\EventDispatcher\Subscriber\DoctrineProxySubscriber;
use FastPix\Sdk\Serializer\EventDispatcher\Subscriber\EnumSubscriber;
...
use FastPix\Sdk\Serializer\GraphNavigator\Factory\DeserializationGraphNavigatorFactory;
use FastPix\Sdk\Serializer\GraphNavigator\Factory\GraphNavigatorFactoryInterface;
use FastPix\Sdk\Serializer\GraphNavigator\Factory\SerializationGraphNavigatorFactory;
use FastPix\Sdk\Serializer\Handler\ArrayCollectionHandler;
use FastPix\Sdk\Serializer\Handler\DateHandler;
use FastPix\Sdk\Serializer\Handler\EnumHandler;
...
use FastPix\Sdk\Serializer\Handler\UnionHandler;
use FastPix\Sdk\Serializer\Naming\CamelCaseNamingStrategy;
use FastPix\Sdk\Serializer\Naming\PropertyNamingStrategyInterface;
use FastPix\Sdk\Serializer\Naming\SerializedNameAnnotationStrategy;
use FastPix\Sdk\Serializer\Type\Parser;
use FastPix\Sdk\Serializer\Type\ParserInterface;
use FastPix\Sdk\Serializer\Visitor\Factory\DeserializationVisitorFactory;
use FastPix\Sdk\Serializer\Visitor\Factory\JsonDeserializationVisitorFactory;
use FastPix\Sdk\Serializer\Visitor\Factory\JsonSerializationVisitorFactory;
use FastPix\Sdk\Serializer\Visitor\Factory\SerializationVisitorFactory;
use FastPix\Sdk\Serializer\Visitor\Factory\XmlDeserializationVisitorFactory;
use FastPix\Sdk\Serializer\Visitor\Factory\XmlSerializationVisitorFactory;
...
final class SerializerBuilder
{
    ...
    /**
     * @var object|null Doctrine\Common\Annotations\Reader when set (optional; PHP 8+ uses attributes)
     */
    ...
    public function setAnnotationReader(object $reader): self
    {
    ...
    {
        $this->listenersConfigured = true;
        // Only add Doctrine proxy subscriber when Doctrine Persistence is available (optional dependency)
    ...
    public function build(): Serializer
    {
        ...
        if (null === $annotationReader && class_exists('Doctrine\Common\Annotations\AnnotationReader')) {
            $annotationReader = $this->decorateAnnotationReader(new \Doctrine\Common\Annotations\AnnotationReader());
        }
    ...
    /**
     * @param object $annotationReader Doctrine\Common\Annotations\AnnotationReader
     * @return object
     */
