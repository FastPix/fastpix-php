...
class SDKConfiguration
{
    ...
    public string $userAgent = 'speakeasy-sdk/php 0.0.1 2.597.9 1.0.0 fastpix/sdk';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(FastPix::SERVERS[$this->serverIndex])) {
            return FastPix::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(FastPix::SERVERS[$this->serverIndex], []);
