...
class SDKConfiguration
{
    ...
    public string $userAgent = 'fastpix-sdk/php 1.0.4 2.801.0 1.0.0 fastpix/sdk';
    ...
    public function getServerUrl(): string
    {
        ...
        if (isset(Fastpixsdk::SERVERS[$this->serverIndex])) {
            return Fastpixsdk::SERVERS[$this->serverIndex];
        } else {
    ...
    public function getServerDetails(): Utils\ServerDetails
    {
        ...
        return new Utils\ServerDetails(Fastpixsdk::SERVERS[$this->serverIndex], []);
