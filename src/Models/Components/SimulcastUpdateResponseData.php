...
class SimulcastUpdateResponseData
{
     ...
     *
     * @var ?SimulcastUpdateResponseMetadata $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('\FastPix\Sdk\Models\Components\SimulcastUpdateResponseMetadata|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?SimulcastUpdateResponseMetadata $metadata = null;
     ...
     * @param  ?SimulcastUpdateResponseMetadata  $metadata
     * @phpstan-pure
     */
    public function __construct(?string $simulcastId = null, ?string $url = null, ?string $streamKey = null, ?bool $isEnabled = null, ?SimulcastUpdateResponseMetadata $metadata = null)
    {
