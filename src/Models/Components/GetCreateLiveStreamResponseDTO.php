...
class GetCreateLiveStreamResponseDTO
{
     ...
     *
     * @var ?GetCreateLiveStreamResponseDTOMetadata $metadata
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('metadata')]
    #[\Speakeasy\Serializer\Annotation\Type('\FastPix\Sdk\Models\Components\GetCreateLiveStreamResponseDTOMetadata|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?GetCreateLiveStreamResponseDTOMetadata $metadata = null;
     ...
     *
     * @var ?GetCreateLiveStreamResponseDTOSrtPlaybackResponse $srtPlaybackResponse
     */
    #[\Speakeasy\Serializer\Annotation\SerializedName('srtPlaybackResponse')]
    #[\Speakeasy\Serializer\Annotation\Type('\FastPix\Sdk\Models\Components\GetCreateLiveStreamResponseDTOSrtPlaybackResponse|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
    public ?GetCreateLiveStreamResponseDTOSrtPlaybackResponse $srtPlaybackResponse = null;
     ...
     * @param  ?GetCreateLiveStreamResponseDTOMetadata  $metadata
     * @param  ?array<PlaybackIds>  $playbackId
     * @param  ?GetCreateLiveStreamResponseDTOSrtPlaybackResponse  $srtPlaybackResponse
     * @phpstan-pure
     */
    public function __construct(?string $streamId = null, ?string $streamKey = null, ?string $srtSecret = null, ?bool $trial = null, ?string $status = null, ?string $maxResolution = null, ?int $maxDuration = null, ?\DateTime $createdAt = null, ?bool $enableRecording = null, ?string $mediaPolicy = null, ?GetCreateLiveStreamResponseDTOMetadata $metadata = null, ?array $playbackId = null, ?GetCreateLiveStreamResponseDTOSrtPlaybackResponse $srtPlaybackResponse = null, ?int $reconnectWindow = 60)
    {
