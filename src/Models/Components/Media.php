...
class Media
{
    ...
    #[\Speakeasy\Serializer\Annotation\Type('\FastPix\Sdk\Models\Components\MediaSourceResolution|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(?string $thumbnail = null, ?string $id = null, ?string $workspaceId = null, ?array $metadata = null, ?string $status = null, ?MediaMp4Support $mp4Support = null, ?bool $sourceAccess = null, ?array $playbackIds = null, ?array $tracks = null, ?string $duration = null, ?string $frameRate = null, ?string $aspectRatio = null, ?\DateTime $createdAt = null, ?\DateTime $updatedAt = null, ?MediaMaxResolution $maxResolution = MediaMaxResolution::OneThousandAndEightyp, ?MediaSourceResolution $sourceResolution = MediaSourceResolution::OneThousandAndEightyp)
    {
