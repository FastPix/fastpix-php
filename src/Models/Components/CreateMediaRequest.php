...
class CreateMediaRequest
{
    ...
    #[\Speakeasy\Serializer\Annotation\Type('\FastPix\Sdk\Models\Components\Subtitles|null')]
    #[\Speakeasy\Serializer\Annotation\SkipWhenNull]
     ...
     * @phpstan-pure
     */
    public function __construct(array $inputs, CreateMediaRequestAccessPolicy $accessPolicy, ?array $metadata = null, ?Subtitles $subtitles = null, ?CreateMediaRequestMp4Support $mp4Support = null, ?bool $sourceAccess = null, ?Summary $summary = null, ?bool $chapters = null, ?bool $namedEntities = null, ?Moderation $moderation = null, ?CreateMediaRequestAccessRestrictions $accessRestrictions = null, ?bool $optimizeAudio = false, ?CreateMediaRequestMaxResolution $maxResolution = CreateMediaRequestMaxResolution::OneThousandAndEightyp)
    {
        $this->inputs = $inputs;
