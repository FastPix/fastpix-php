...
class CreateMediaResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(?string $id = null, ?string $status = null, ?\DateTime $createdAt = null, ?\DateTime $updatedAt = null, ?array $playbackIds = null, ?array $metadata = null, ?bool $trial = true, ?CreateMediaResponseMaxResolution $maxResolution = CreateMediaResponseMaxResolution::OneThousandAndEightyp)
    {
        $this->id = $id;
        $this->status = $status;
