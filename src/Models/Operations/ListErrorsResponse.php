...
class ListErrorsResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?ListErrorsResponseBody $object = null, ?Components\DefaultError $defaultError = null)
    {
