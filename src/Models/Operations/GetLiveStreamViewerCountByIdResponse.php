...
class GetLiveStreamViewerCountByIdResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\ViewsCountResponse $viewsCountResponse = null, ?Components\DefaultError $defaultError = null)
    {
