...
class DeleteMediaFromPlaylistRequest
{
    /**
    ...
    public ?Components\MediaIdsRequest $mediaIdsRequest = null;
     ...
     * @phpstan-pure
     */
    public function __construct(string $playlistId, ?Components\MediaIdsRequest $mediaIdsRequest = null)
    {
