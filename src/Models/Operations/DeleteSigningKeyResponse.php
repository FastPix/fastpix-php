...
class DeleteSigningKeyResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\DeleteSigningKeyResponse $deleteSigningKeyResponse = null, ?Components\DefaultError $defaultError = null)
    {
