...
class GetDrmConfigurationByIdResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?GetDrmConfigurationByIdResponseBody $object = null, ?Components\DefaultError $defaultError = null)
    {
