...
class ListDimensionsResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?ListDimensionsResponseBody $object = null, ?Components\DefaultError $defaultError = null)
    {
