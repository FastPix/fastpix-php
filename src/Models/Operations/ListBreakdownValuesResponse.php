...
class ListBreakdownValuesResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?ListBreakdownValuesResponseBody $object = null, ?Components\DefaultError $defaultError = null)
    {
