...
class GenerateSubtitleTrackResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?GenerateSubtitleTrackResponseBody $object = null, ?Components\DefaultError $defaultError = null)
    {
