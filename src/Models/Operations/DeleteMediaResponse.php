...
class DeleteMediaResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?DeleteMediaResponseBody $object = null, ?Components\DefaultError $defaultError = null)
    {
