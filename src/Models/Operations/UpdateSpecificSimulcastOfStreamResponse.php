...
class UpdateSpecificSimulcastOfStreamResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\SimulcastUpdateResponse $simulcastUpdateResponse = null, ?Components\DefaultError $defaultError = null)
    {
