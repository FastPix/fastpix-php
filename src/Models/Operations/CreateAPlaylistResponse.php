...
class CreateAPlaylistResponse
{
     ...
     * @phpstan-pure
     */
    public function __construct(string $contentType, int $statusCode, \Psr\Http\Message\ResponseInterface $rawResponse, ?Components\PlaylistCreatedResponse $playlistCreatedResponse = null, ?Components\DefaultError $defaultError = null)
    {
