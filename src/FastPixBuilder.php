...
/**
 * FastPixBuilder is used to configure and build an instance of the SDK.
 */
class FastPixBuilder
{
     ...
     */
    public function setClient(\GuzzleHttp\ClientInterface $client): FastPixBuilder
    {
     ...
     * @return FastPixBuilder
     */
    public function setSecurity(Models\Components\Security $security): FastPixBuilder
    {
     ...
     * @return FastPixBuilder
     */
    public function setSecuritySource(\Closure $securitySource): FastPixBuilder
    {
     ...
     * @return FastPixBuilder
     */
    public function setServerUrl(string $serverUrl, ?array $params = null): FastPixBuilder
    {
     ...
     * @return FastPixBuilder
     */
    public function setServerIndex(int $serverIdx): FastPixBuilder
    {
    ...
    public function setRetryConfig(Retry\RetryConfig $config): FastPixBuilder
    {
    ...
    public function build(): FastPix
    {
        ...
        return new FastPix($this->sdkConfig);
    }
}