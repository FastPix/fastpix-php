...
/**
 * Working Test Runner for FastPix PHP SDK
 * Tests only the resources that work properly with real credentials
 */
...
class WorkingTestRunner
{
    ...
    {
        echo "\n".str_repeat('=', 80)."\n";
        echo "FASTPIX PHP SDK - WORKING TEST RUNNER\n";
        echo str_repeat('=', 80)."\n";
        echo "Testing SDK resources that work with real credentials\n";
        ...
        try {
            ...
            $this->testResource('InputVideo - Create Media', function () use ($sdk) {
                $request = new \FastPix\Sdk\Models\Components\CreateMediaRequest(
                    ...
                    metadata: ['title' => 'Test Video from Working Test Runner'],
            ...
            $this->testResource('ManageLiveStream - List Live Streams', function () use ($sdk) {
