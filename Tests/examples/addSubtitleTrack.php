...
try {
    ...
    // The ID of the media to add a subtitle track to
     $mediaId = '7b5b5ee7-a7df-454d-906d-6f0dfcb57bc1';


    $body = new Operations\AddMediaTrackRequestBody(
        tracks: new Components\AddTrackRequest(
            url: 'https://static.fastpix.com/subtitles-en.vtt',
            type: Components\AddTrackRequestType::Subtitle,
            languageCode: 'en',
