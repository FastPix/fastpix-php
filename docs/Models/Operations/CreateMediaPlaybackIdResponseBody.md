...
| `data`                                                                       | [?Components\CreatePlaybackId](../../Models/Components/CreatePlaybackId.md)  | :heavy_minus_sign:                                                           | A collection of Playback ID objects utilized for crafting HLS playback urls. |                                                                              |